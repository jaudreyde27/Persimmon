      ...
      <main>
        <section className="relative overflow-hidden bg-apricot-100">
          ...
          <div
            ...
            aria-hidden="true"
          />
          <div className="relative z-10 mx-auto max-w-2xl px-4 py-10 text-center sm:px-6 sm:py-14">
            <p className="font-heading text-sm font-semibold uppercase tracking-[0.2em] text-apricot-600">
              For Patients
            </p>
            <h1 className="mt-4 font-heading text-3xl font-bold tracking-tight text-apricot-900 sm:text-5xl">
